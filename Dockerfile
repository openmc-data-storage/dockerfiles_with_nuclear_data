...
# docker pull ghcr.io/openmc-data-storage/miniconda3_4.10.3_endfb-7.1_nndc_tendl_2019

# To build this Dockerfile into a docker image:
# docker build -t miniconda3_4.10.3_endfb-7.1_nndc_tendl_2019 .

# To run the locally built Docker image:
# docker run -it miniconda3_4.10.3_endfb-7.1_nndc_tendl_2019

# To run the prebuilt Docker image:
# docker run -it ghcr.io/fusion-energy/miniconda3_4.10.3_endfb-7.1_nndc_tendl_2019
